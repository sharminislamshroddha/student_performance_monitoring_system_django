...
course = Course_T(courseID='EEE223', courseName="Mechanical Engineering Fundamentals",
                  numOfCredits=4, program_id=3, courseType="Core")
course.save()
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=4304))
instructors.append(Instructor_T.objects.get(pk=4305))
instructors.append(Instructor_T.objects.get(pk=4306))
