...
instructors = []
instructors.append(Instructor_T.objects.get(pk=4404))
instructors.append(Instructor_T.objects.get(pk=4405))
instructors.append(Instructor_T.objects.get(pk=4406))
