...
course = Course_T(courseID='CSE101', courseName="Introduction to Computer Programming",
                  numOfCredits=4, program_id=7, courseType="Foundation")
course.save()
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("CSE101_BRAC.xlsx", sheet_name="Marks")
