...
course = Course_T(courseID='CSE214', courseName="Computer Organization and Architecture",
                  numOfCredits=3, program_id=7, courseType="Core")
course.save()
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("CSE214_BRAC.xlsx", sheet_name="Marks")
