...
course = Course_T(courseID='MIS465', courseName="E-commerce", numOfCredits=3, program_id=10,
                  courseType="Core")
course.save()

# CO
plolist = list(PLO_T.objects.filter(program_id=4))
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("MIS465_BRAC.xlsx", sheet_name="Marks")
