...
course = Course_T(courseID='EEE132', courseName="Introduction to Materials and Chemistry",
                  numOfCredits=4, program_id=3, courseType="Foundation")
course.save()

# CO
plolist = list(PLO_T.objects.filter(program_id=3))
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=4301))
instructors.append(Instructor_T.objects.get(pk=4302))
instructors.append(Instructor_T.objects.get(pk=4303))

dept = Department_T.objects.get(pk=3)
