...
course = Course_T(courseID='BUS201', courseName="Introduction to Business",
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=5201))
instructors.append(Instructor_T.objects.get(pk=5202))
instructors.append(Instructor_T.objects.get(pk=5203))
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("BUS201_BRAC.xlsx", sheet_name="Marks")
