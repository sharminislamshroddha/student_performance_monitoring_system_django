...
course = Course_T(courseID='EEE313', courseName="Electromagnetic Fields and Waves",
                  numOfCredits=3, program_id=3, courseType="Core")
course.save()
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=4307))
instructors.append(Instructor_T.objects.get(pk=4308))
instructors.append(Instructor_T.objects.get(pk=4309))
