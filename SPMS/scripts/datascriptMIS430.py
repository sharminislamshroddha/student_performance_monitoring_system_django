...
instructors = []
instructors.append(Instructor_T.objects.get(pk=4401))
instructors.append(Instructor_T.objects.get(pk=4402))
instructors.append(Instructor_T.objects.get(pk=4403))

dept = Department_T.objects.get(pk=4)
