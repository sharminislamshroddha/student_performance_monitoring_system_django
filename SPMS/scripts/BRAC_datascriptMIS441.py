...
course = Course_T(courseID='MIS441', courseName="Accounting Information Systems", numOfCredits=3, program_id=10,
                  courseType="Core")
course.save()
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=5404))
instructors.append(Instructor_T.objects.get(pk=5405))
instructors.append(Instructor_T.objects.get(pk=5406))
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("MIS441_BRAC.xlsx", sheet_name="Marks")
