...
course = Course_T(courseID='CSE309', courseName="Web Applications and Internet",
                  numOfCredits=3, program_id=1, courseType="Core")
course.save()
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=4101))
instructors.append(Instructor_T.objects.get(pk=4102))
instructors.append(Instructor_T.objects.get(pk=4103))
