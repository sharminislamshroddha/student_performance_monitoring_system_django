...
course = Course_T(courseID='GSG210', courseName="Theory of International Relations", numOfCredits=3, program_id=12,
                  courseType="Core")
course.save()
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("GSG210_BRAC.xlsx", sheet_name="Marks")
