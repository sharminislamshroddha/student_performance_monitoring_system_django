...
course = Course_T(courseID='GSG310', courseName="Dynamics of International Organizations", numOfCredits=3, program_id=12,
                  courseType="Core")
course.save()
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=5604))
instructors.append(Instructor_T.objects.get(pk=5605))
instructors.append(Instructor_T.objects.get(pk=5606))
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("GSG310_BRAC.xlsx", sheet_name="Marks")
