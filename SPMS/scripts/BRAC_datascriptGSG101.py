...
course = Course_T(courseID='GSG101', courseName="Introduction To Global Studies", numOfCredits=3, program_id=12,
                  courseType="Core")
course.save()
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("GSG101_BRAC.xlsx", sheet_name="Marks")
