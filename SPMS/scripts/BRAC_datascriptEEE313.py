...
course = Course_T(courseID='EEE313', courseName="Electromagnetic Fields and Waves",
                  numOfCredits=3, program_id=9, courseType="Core")
course.save()
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=5307))
instructors.append(Instructor_T.objects.get(pk=5308))
instructors.append(Instructor_T.objects.get(pk=5309))
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("EEE313_BRAC.xlsx", sheet_name="Marks")
