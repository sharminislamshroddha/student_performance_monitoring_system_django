...
course = Course_T(courseID='GSG310', courseName="Dynamics of International Organizations", numOfCredits=3, program_id=6,
                  courseType="Core")
course.save()

# CO
plolist = list(PLO_T.objects.filter(program_id=6))
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=4604))
instructors.append(Instructor_T.objects.get(pk=4605))
instructors.append(Instructor_T.objects.get(pk=4606))

dept = Department_T.objects.get(pk=6)
