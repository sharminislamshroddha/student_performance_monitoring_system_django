...
course = Course_T(courseID='CSE101', courseName="Introduction to Computer Programming",
                  numOfCredits=4, program_id=1, courseType="Foundation")
course.save()

# CO
plolist = list(PLO_T.objects.filter(program_id=1))
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=4104))
instructors.append(Instructor_T.objects.get(pk=4105))
instructors.append(Instructor_T.objects.get(pk=4106))

dept = Department_T.objects.get(pk=1)
