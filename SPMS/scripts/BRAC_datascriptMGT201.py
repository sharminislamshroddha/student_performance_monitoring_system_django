...
course = Course_T(courseID='MGT201', courseName="Principles of Management",
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=5207))
instructors.append(Instructor_T.objects.get(pk=5208))
instructors.append(Instructor_T.objects.get(pk=5209))
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("MGT201_BRAC.xlsx", sheet_name="Marks")
