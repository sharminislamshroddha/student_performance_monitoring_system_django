...
course = Course_T(courseID='CSE309', courseName="Web Applications and Internet",
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=5101))
instructors.append(Instructor_T.objects.get(pk=5102))
instructors.append(Instructor_T.objects.get(pk=5103))
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("CSE309_BRAC.xlsx", sheet_name="Marks")
