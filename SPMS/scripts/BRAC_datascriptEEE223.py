...
course = Course_T(courseID='EEE223', courseName="Mechanical Engineering Fundamentals",
                  numOfCredits=4, program_id=9, courseType="Core")
course.save()
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=5304))
instructors.append(Instructor_T.objects.get(pk=5305))
instructors.append(Instructor_T.objects.get(pk=5306))
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("EEE223_BRAC.xlsx", sheet_name="Marks")
