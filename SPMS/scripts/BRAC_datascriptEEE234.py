...
course = Course_T(courseID='EEE234', courseName="Electronics II",
                  numOfCredits=4, program_id=9, courseType="Core")
course.save()

# CO
plolist = list(PLO_T.objects.filter(program=9))
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("EEE234_BRAC.xlsx", sheet_name="Marks")
