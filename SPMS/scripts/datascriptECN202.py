...
course = Course_T(courseID='ECN202', courseName="Principles of Macroeconomics",
                  numOfCredits=3, program_id=2, courseType="Core")
course.save()

# CO
plolist = list(PLO_T.objects.filter(program_id=2))
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=4204))
instructors.append(Instructor_T.objects.get(pk=4205))
instructors.append(Instructor_T.objects.get(pk=4206))

dept = Department_T.objects.get(pk=2)
