...
instructors = []
instructors.append(Instructor_T.objects.get(pk=4107))
instructors.append(Instructor_T.objects.get(pk=4108))
instructors.append(Instructor_T.objects.get(pk=4109))
