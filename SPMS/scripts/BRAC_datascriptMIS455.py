...
course = Course_T(courseID='MIS455', courseName="Web Applications and Internet", numOfCredits=3, program_id=10,
                  courseType="Core")
course.save()
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("MIS455_BRAC.xlsx", sheet_name="Marks")
