...
course = Course_T(courseID='CSE104', courseName="Electrical Circuit Analysis",
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=5107))
instructors.append(Instructor_T.objects.get(pk=5108))
instructors.append(Instructor_T.objects.get(pk=5109))
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("CSE104_BRAC.xlsx", sheet_name="Marks")
