...
course = Course_T(courseID='ELT201', courseName="ELT abc",
                  numOfCredits=3, program_id=11, courseType="Core")
course.save()
...
instructors = []
instructors.append(Instructor_T.objects.get(pk=5501))
instructors.append(Instructor_T.objects.get(pk=5502))
instructors.append(Instructor_T.objects.get(pk=5503))
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("ELT201_BRAC.xlsx", sheet_name="Marks")
