...
# admin.site.register(University_T)
...
# admin.site.register(Account_T)
# admin.site.register(Instructor_T)
...
# admin.site.register(CO_Course_T)
# admin.site.register(Registration_T)
# admin.site.register(Assessment_T)
# admin.site.register(Evaluation_T)

class University_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in University_T._meta.fields if field.name != "id"]


admin.site.register(University_T, University_TAdmin)
...
class Program_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in Program_T._meta.fields if field.name != "id"]
...
class Student_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in Student_T._meta.fields if field.name != "id"]
...
class VC_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in VC_T._meta.fields if field.name != "id"]
...
class Dean_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in Dean_T._meta.fields if field.name != "id"]
...
class Head_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in Head_T._meta.fields if field.name != "id"]


admin.site.register(Head_T, Head_TAdmin)


class Instructor_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in Instructor_T._meta.fields if field.name != "id"]


admin.site.register(Instructor_T, Instructor_TAdmin)
...
class PrereqCourse_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in PrereqCourse_T._meta.fields if field.name != "id"]
...
class PLO_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in PLO_T._meta.fields if field.name != "id"]
...
class CO_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in CO_T._meta.fields if field.name != "id"]


admin.site.register(CO_T, CO_TAdmin)


class CO_Course_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in CO_Course_T._meta.fields if field.name != "id"]


admin.site.register(CO_Course_T, CO_Course_TAdmin)


class Registration_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in Registration_T._meta.fields if field.name != "id"]
...
class Assessment_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in Assessment_T._meta.fields if field.name != "id"]
...
class Evaluation_TAdmin(admin.ModelAdmin):
    list_display = [
        field.name for field in Evaluation_T._meta.fields if field.name != "id"]
